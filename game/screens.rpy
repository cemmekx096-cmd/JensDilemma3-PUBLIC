...
###############################################################################################
screen opportunitiesUI():
    add "opportunities.png"
    ...
    frame:
        ...
        yalign 0.56
        hbox:
            text "Relationship: [mrel]"

    frame:
        xalign 0.1315
        yalign 0.89
        hbox:
            text "Corruption: [mcorr]"
...
#sname
    ...
    frame:
        ...
        yalign 0.56
        hbox:
            text "Relationship: [srel]"

    frame:
        xalign 0.397
        yalign 0.89
        hbox:
            text "Corruption: [scorr]"
...
#money_soon
    ...
    frame:
        ...
        yalign 0.89
        hbox:
            text "ANESTHETIC: [banesthetic]"


    textbutton "RETURN" action Jump("broom_menu") xalign 0.50 yalign 0.95
...
#
screen jcorr:
    text "Joshua'S CORRUPTION LEVEL HAS INCREASED" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]

screen anotify:
    text "YOU HAVE USED 1 DOSE OF ANESTHETIC. USE IT WISELY" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]

screen wsuspup:
    text "WANDA SUSPICIONS INCREASED, HER SUSPICION NOW IS AT [wsusp]" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]

screen wsuspdw:
    text "WANDA SUSPICIONS DECREASED, HER SUSPICION NOW IS AT [wsusp]" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]
...
screen gnav():
    hbox:
        ...
        imagebutton idle "nav/cel.png" hover "nav/cellh.png" clicked Jump("opportunities")
    ...
    if Hour == 9:
        ...
        if day !=7 and joshjaneyphotos == 3 and joshuadaydone ==0:
            textbutton "Door bell?!" action Jump("joshuaday") xalign 0.55 yalign 0.30
        hbox:
            xalign 0.350
            yalign 0.72
            add "char/sico.png"
